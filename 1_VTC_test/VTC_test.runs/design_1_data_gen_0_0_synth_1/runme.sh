...
HD_PWD='E:/FPGA_Project/2020_2/CNN/proj/VTC_test/VTC_test.runs/design_1_data_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_data_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_data_gen_0_0.tcl
