...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_lite_ipif_v3_0_4 -L v_tc_v6_2_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
